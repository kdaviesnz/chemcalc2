...
dimethyl_ether[1].length.should.be.equal(4)
dimethyl_ether[1][0][0].should.be.equal("Al")
dimethyl_ether[1][1][0].should.be.equal("Cl")
dimethyl_ether[1][2][0].should.be.equal("Cl")
dimethyl_ether[1][3][0].should.be.equal("Cl")
Set().intersection(dimethyl_ether[1][1].slice(5), dimethyl_ether[1][0].slice(5)).length.should.be.equal(2)
Set().intersection(dimethyl_ether[1][2].slice(5), dimethyl_ether[1][0].slice(5)).length.should.be.equal(2)
Set().intersection(dimethyl_ether[1][3].slice(5), dimethyl_ether[1][0].slice(5)).length.should.be.equal(2)
...
dimethyl_ether[1][0].slice(5).length.should.be.equal(6)
dimethyl_ether[1][1].slice(5).length.should.be.equal(8)
dimethyl_ether[1][2].slice(5).length.should.be.equal(8)
aluminium_chloride[1][3].slice(5).length.should.be.equal(8)
const dimethyl_ether_oxygen = CAtom(dimethyl_ether[1][0], 0, [dimethyl_ether,1])
dimethyl_ether_oxygen.hydrogens().length.should.be.equal(0)
dimethyl_ether_oxygen.carbons().length.should.be.equal(0)
dimethyl_ether_oxygen.freeSlots().should.be.equal(12)
dimethyl_ether_oxygen.bondCount().should.be.equal(3)
...
MoleculeController([dimethyl_ether,1]).nucleophileIndex().should.be.equal(1)
console.log('done')
process.exit()
