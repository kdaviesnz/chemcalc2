...
console.log("expoxide ring opening via methoxide step 2 - BREAK bond - C-O epoxide bond of the attacked carbon breaks. Oxygen atom should now have a negative charge.")
