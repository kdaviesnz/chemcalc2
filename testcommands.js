...
const deprotonated_products = CommandTest("DEPROTONATE", [isopropyl_cation,1], [hydrogen_sulfate,1])

console.log(VMolecule(deprotonated_products[0]).canonicalSMILES())
