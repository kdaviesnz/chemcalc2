...
reduceImineToAmineReverse_result = reaction.reduceImineToAmineReverse(nitrogen_index, carbon_index, true)
VMolecule(reduceImineToAmineReverse_result[0]).canonicalSMILES().should.be.equal("CC(CC1=CC=CC=C1)=O")
VMolecule(reduceImineToAmineReverse_result[1]).canonicalSMILES().should.be.equal("CN")
