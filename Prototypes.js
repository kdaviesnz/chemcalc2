...
const Prototypes = () => {
    ...
    Object.defineProperty(Array.prototype, 'branchesv2', {
        value: function(branches, atom_index, new_branch) {
            ...
            if (atom_index<0) {
                console.log("branches")
                console.log(branches)    // [[C1]]
                console.log("child_bonds")
                console.log(child_bonds) // // [P2]
                console.log("atom")
                console.log(atom)   // [C1]
                console.log("new branch")
                console.log(new_branch) // false
                process.error()
            }
            ...
            if (atom_index===10000) {
                console.log("branches")
                console.log(branches)  // [[C1,P1]]
                console.log("child_bonds")
                console.log(child_bonds) // ["=O1", "C4"]
                console.log("atom")
                console.log(atom)  // P1
                console.log("new branch")
                console.log(new_branch) // false
            ...
            if (atom_index===4000) {
                console.log("branches")
                console.log(branches) // [[C1, P2, "=O1","=O1],[C1,P2,"=O1", "=O1"]]
                console.log("child_bonds")
                console.log(child_bonds) // []
                console.log("atom")
                console.log(atom)   // "=O1"
            ...
            if (child_bonds.length === 0) {
                ...
                branches.addAtomToBranch(child_bonds[0].atom, atom_index)

                if (atom_index===300000){
                    console.log(branches)
