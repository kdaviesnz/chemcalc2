...
const HydrideShiftOnCarbonNitrogenBondReverse = (container_substrate, reagent, rule, DEBUG) => {
    ...
    reaction.hydrideShiftOnCarbonNitrogenBondReverse()
...
module.exports = HydrideShiftOnCarbonNitrogenBondReverse
