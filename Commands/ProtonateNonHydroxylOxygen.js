...
const ProtonateNonHyroxylOxygen = (container_molecule, container_reagent, rule, DEBUG) => {


    if (DEBUG) {
        console.log("Commands/ProtonateNonHyroxylOxygen.js -> Running command reaction.addProtonFromReagentToHydroxylGroup")
