...
const ProtonateCarbonyl = (container_molecule, container_reagent, rule, DEBUG) => {

    if (DEBUG) {
        console.log("Commands/ProtonateCarbonyl.js -> Running command reaction.protonateCarbonyl")
    ...
    const result = reaction.protonateCarbonyl()
...
module.exports = ProtonateCarbonyl